...
const BestSellingProduct = ({ product }) => {
  const { _id, name, price, rating, stock, category, image } = product;
  ...
  return (
    <div className="group bg-[#F4F0ED] rounded-3xl shadow-md hover:shadow-xl transition-all duration-500 transform hover:scale-101 overflow-hidden h-full flex flex-col border border-[#D9DFD7] relative">
      ...
      <div className="relative overflow-hidden">
        ...
        {/* 🔥 Best Review Badge */}
        <span className="absolute top-4 left-1/5 -translate-x-1/2 bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-md animate-pulse">
          🔥 Best Review
        </span>
        ...
        {/* Rating */}
        <div className="absolute bottom-4 right-4 bg-[#D9DFD7] text-[#415765] px-2.5 py-1 rounded-xl shadow-sm border border-[#D9DFD7] flex items-center gap-1 transform transition-transform duration-300 group-hover:scale-105">
